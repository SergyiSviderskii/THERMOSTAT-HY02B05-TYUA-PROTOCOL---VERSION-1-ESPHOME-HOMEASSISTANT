...
class Tuya : public Component, public uart::UARTDevice {
 public:
  ...
  uint8_t my_global_mode = 0;
  void get_datapoint_addition (uint8_t datapoint_id, bool point_id);
  optional<TuyaDatapoint> datapoint_id_1{};
  optional<TuyaDatapoint> datapoint_id_2{};
